    ...
    internal static unsafe class ARGB1555
    {
        public static YFBitmap Read(BinaryStream bs, int width, int height)
        {
            ...
            for (int i = 0; i < S; i++)
            {
                ...
                g = (temp & 0x3E0) >> 5;
                b = temp & 0x1F;
                *pixels++ = new YFColor((byte)((r << 3) | (r >> 2)), (byte)((g << 3) | (g >> 2)), (byte)((b << 3) | (b >> 2)), (byte)((temp & 0x8000) == 0 ? 0 : 255));
            }
            return image;
        }
        ...
        public static int Write(BinaryStream bs, YFBitmap image)
        {
            ...
            for (int i = 0; i < S; i++)
            {
                bs.WriteUInt16((ushort)(((pixels->Alpha & 0b10000000) << 8) | ((pixels[i].Blue & 0xF8) >> 3) | ((pixels->Green & 0xF8) << 2) | ((pixels->Red & 0xF8) << 7)));
                pixels++;
            }
