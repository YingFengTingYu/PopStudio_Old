namespace PopStudio.Language.Languages
{
    internal class MAUIENUS : ILocalization
    {
        ...
        public string HomePage_AppNewNotice => "1.Optimize App UI; \n2.Change the data generated by RSB unpacking to support different compression methods; \n3.Delete the CMD support with GUI version program and publish the CMD version program. ";
        //Share
