namespace PopStudio.Language.Languages
{
    internal class MAUIENUS : ILocalization
    {
        ...
        public string HomePage_AppNewNotice => "1.Optimize App UI; \n2.Change the data generated by RSB unpacking to support different compression methods, special pool parts and rsb with more than 2GB size; \n3.Support decoding and encoding PTX with DXT5_RGBA_MortonBlock format from rsb in ps4; \n4.Use Native AOT to increase speed; \n5.Delete the CMD support with GUI version program and publish the CMD version program. ";
        //Share
