...
local loc = {
	[0] = { --ZHCN
		Name = "RTONBatchEncode.lua 作者：萌新迎风听雨",
		Description = "说明：一个将指定文件夹内的所有json文件转为RTON后缀格式文件的批处理脚本",
		Error = "请输入文件夹位置",
		OutFormat = "请选择RTON格式",
        DeleteTitle = "删除文件",
        Delete = "是否删除被转换的文件",
	...
	[1] = { --ENUS
		Name = "RTONBatchEncode.lua Author: YingFengTingYu",
		Description = "Description: A batch script that converts all json files in the specified folder into RTON files",
